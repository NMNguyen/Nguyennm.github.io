...
function post_comment(unique_key, obj_id) {
        ...
        if(content.length==0){
            $("#error-msg").show();
            $("#error-msg").text('*{% trans "This field cannot be empty." %}');
            ...
            var month = '';
            if (['1', '2', '3'].indexOf(v.organization.monthly_review_lock) != -1) {
                month = v.organization.monthly_review_lock;
            }
            ...
            var data = {
                ...
                file_url: file_url,
                month: month,
                is_admin_kpi: $("#id_is_admin_kpi").is(":checked")
            };
